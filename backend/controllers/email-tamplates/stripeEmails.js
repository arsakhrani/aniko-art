...
module.exports.setNewBidSeller = (name, bid, artwork) => {
  ...
  you can do so by visiting the artwork on Aniko van Nie Art Agency and clicking "Accept Bid".
...
module.exports.informOldBidHolder = (name, bid, artwork) => {
  ...
  To do so, please visit the artwork on Aniko van Nie Art Agency and click on "Bid"</p>
  <br>
  <p>Warm Regards,</p>
  <p>Your Aniko van Nie // Art Agency Team</p>`;
};

module.exports.informBidderOfCanceledBid = (name, artwork) => {
  return `<p>Dear ${name},</p>
  <br>
  <p>This is to inform you that the owner of ${artwork.title} by ${artwork.artist} 
  did not accept your offer within the alloted time.
  A team memember from Aniko Art Agency will get in touch with you shortly</p>
  <br>
  <p>Warm Regards,</p>
  <p>Your Aniko van Nie // Art Agency Team</p>`;
};

module.exports.informBuyerOfSaleProcess = () => {
  return `<p>Dear ,</p>
  <br>
  <p>BLA</p>
  <br>
